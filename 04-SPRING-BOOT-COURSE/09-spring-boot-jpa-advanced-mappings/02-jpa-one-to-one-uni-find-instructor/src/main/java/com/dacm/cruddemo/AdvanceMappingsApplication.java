...
import com.dacm.cruddemo.repository.AppRepository;
...
public class AdvanceMappingsApplication {
	...
	@Bean
	public CommandLineRunner commandLineRunner(AppRepository appDAO) {
	...
	private void createInstructor(AppRepository appDAO) {
